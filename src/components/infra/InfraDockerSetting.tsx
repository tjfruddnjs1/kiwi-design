...
import InfraDockerInfoTab from './InfraDockerInfoTab';
import InfraDockerResourceTab from './InfraDockerResourceTab';
...
const InfraDockerSetting: React.FC<InfraDockerSettingProps> = ({
  runtimeDetails,
  selectedInfra,
  onLoading,
  getStoredAuthHops,
  ...
  const [runtimeInfo, setRuntimeInfo] = useState<DockerInfo>(null);
