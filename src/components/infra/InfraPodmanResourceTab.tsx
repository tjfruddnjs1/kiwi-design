...
interface InfraPodmanResourceTabProps {
...
const InfraPodmanResourceTab: React.FC<InfraPodmanResourceTabProps> = ({
  runtimeDetails,
  selectedInfra,
  onLoading,
  getStoredAuthHops,
  ...
  const handleDeleteImages = async () => {
    ...
    const response = (await awxApi.runPlaybook({
      playbook_to_run: 'delete_podman_images',
      hops: hopsWithCreds,
...
export default InfraPodmanResourceTab;
